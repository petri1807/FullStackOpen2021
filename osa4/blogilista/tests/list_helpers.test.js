...
describe('most blogs', () => {
  test('when list has only one blog equals the author and blog count for that', () => {
...
describe('most likes', () => {
  test('when list has only one blog equals the author and likes for that', () => {
    const result = listHelper.mostLikes(listWithOneBlog);
    expect(result).toEqual({ author: 'Edsger W. Dijkstra', likes: 5 });
  });

  test('when list has many blogs equals the author with most likes total', () => {
